...
const TRANSLATIONS = {
    en: {
        ...
        'settings.logs.label':     'Log file',
        'settings.logs.desc':      'For troubleshooting — includes app events and errors, no personal data',
        'settings.logs.open':      'Open',
    ...
    fr: {
        ...
        'settings.logs.label':     'Fichier de log',
        'settings.logs.desc':      'Pour le dépannage — événements et erreurs de l\'app, aucune donnée personnelle',
        'settings.logs.open':      'Ouvrir',
